...
result = requests.get("https://www.newegg.com/gigabyte-geforce-rtx-3080-ti-gv-n308tgaming-oc-12gd/p/N82E16814932436?Item=N82E16814932436&cm_sp=Homepage_SS-_-P4_14-932-436-_-08102022")
doc = BeautifulSoup(result.text, "html.parser")
prices = doc.find_all(text="$")
parent = prices[0].parent
strong = parent.find("strong")

currentPrice = int(strong.text)



while True:
    print(f"Price is: ${currentPrice}")
    if int(strong.text) == currentPrice:
